...
diabetes_model = pickle.load(open(
    '"C:\\Users\\vedan\\OneDrive\\Desktop\\PROJECTS\\MACHINE LEARNING\\MULTIPLE DISEASE PREDICTION USING ML\\diabetes_model.sav"', 'rb'))

heart_disease_model =  pickle.load(open(
    '"C:\\Users\\vedan\\OneDrive\\Desktop\\PROJECTS\\MACHINE LEARNING\\MULTIPLE DISEASE PREDICTION USING ML\\heart_disease_model.sav"', 'rb'))

parkinsons_model = pickle.load(open(
    '"C:\\Users\\vedan\\OneDrive\\Desktop\\PROJECTS\\MACHINE LEARNING\\MULTIPLE DISEASE PREDICTION USING ML\\parkinsons_model.sav"', 'rb'))

breast_cancer_model = pickle.load(open(
    '"C:\\Users\\vedan\\OneDrive\\Desktop\\PROJECTS\\MACHINE LEARNING\\MULTIPLE DISEASE PREDICTION USING ML\\breast_cancer_model.sav"', 'rb'))
...
with st.sidebar:
    selected = option_menu('Multiple Disease Prediction System',
                           ...
                           icons=['house','activity', 'heart', 'person', 'skull','phone','hospital'],
                           default_index=0)
